...
namespace BaiTap1_Provider
{
    ...
    public class PhapAnhService : System.Web.Services.WebService
    {
        ...
        public void InitDictionary()
        {
            ...
            XmlNodeList xmlnode;
            FileStream fs = new FileStream(@"E:\STUDY\AllLearnWork\School\16HCB1\16HCB\HK3\CongNgheLapTrinhHienDai\TaiLieu_BaiTap\D02\1642021\BaiTap1_Provider\FrenchEnglishDict.xml", FileMode.Open, FileAccess.Read);
            xmldoc.Load(fs);
