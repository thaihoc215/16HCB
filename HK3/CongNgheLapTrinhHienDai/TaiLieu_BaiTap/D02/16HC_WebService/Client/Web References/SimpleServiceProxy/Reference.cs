...
namespace Client.SimpleServiceProxy {
    using System;
    ...
    public partial class SimpleService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public SimpleService() {
            this.Url = global::Client.Properties.Settings.Default.Client_SimpleServiceProxy_SimpleService;
        ...
        /// <remarks/>
        public void SumAsync(int x, int y, int z) {
            this.SumAsync(x, y, z, null);
        }
        
        /// <remarks/>
        public void SumAsync(int x, int y, int z, object userState) {
            ...
            this.InvokeAsync("Sum", new object[] {
                        x,
                        y,
                        z}, this.SumOperationCompleted, userState);
        }
