    ...
    public partial class DongHoDienTu : UserControl
    {
        ...
        private void tmClock_Tick(object sender, EventArgs e)
        {
            ...
            if (_isCountDown)
            {
                ...
                picMili1.Image = Image.FromFile(@"..\..\Digits\" + _msc1 + ".png");
                picMili2.Image = Image.FromFile(@"..\..\Digits\" + _msc2 + ".png");
                ...
                ptMinute1.Image = Image.FromFile(@"..\..\Digits\" + _mn1 + ".png");
                ptMinute2.Image = Image.FromFile(@"..\..\Digits\" + _mn2 + ".png");
        ...
        public void StartTime(ListBox lstTime)
        {
            _second = 0;
            _isCountDown = false;
            picMili1.Image = Image.FromFile(@"..\..\Digits\0.png");
            picMili2.Image = Image.FromFile(@"..\..\Digits\0.png");
            ptSecond1.Image = Image.FromFile(@"..\..\Digits\0.png");
            ptSecond2.Image = Image.FromFile(@"..\..\Digits\0.png");
