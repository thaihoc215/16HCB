...
/**
 * Created by TruongNguyen on 12/13/2016.
 */
...
public class HOTPAlgorithm {
    ...
    /**
     * Lấy SecurityCode của user trong thời gian hiện tại
     *
     * @param tokenUser
     * @return
     ...
     */
    public static String GetSecurityCode(String tokenUser, long timeMillis) throws NoSuchAlgorithmException, InvalidKeyException {
        long longtime = timeMillis;
        longtime = longtime - longtime % 60000 + 95369;

        String pass = tokenUser + "_" + longtime;
