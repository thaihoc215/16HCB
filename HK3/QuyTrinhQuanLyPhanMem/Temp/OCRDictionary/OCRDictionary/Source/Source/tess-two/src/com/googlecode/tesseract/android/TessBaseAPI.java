...
public class TessBaseAPI {
    ...
    /** Run Cube only - better accuracy, but slower */
    public static final int PSM_SINGLE_BLOCK = 1;
    
    /** Run both and combine results - best accuracy */
    public static final int PSM_SINGLE_LINE = 2;
    
    /** Default OCR engine mode. */
    public static final int PSM_SINGLE_WORD = 3;
    
    
    /** Run Cube only - better accuracy, but slower */
    public static final int PSM_SINGLE_CHAR = 4;
