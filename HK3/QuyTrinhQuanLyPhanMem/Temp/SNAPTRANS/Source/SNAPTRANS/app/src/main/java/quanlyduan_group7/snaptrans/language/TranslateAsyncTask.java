...
import quanlyduan_group7.snaptrans.R;
...
public final class TranslateAsyncTask extends AsyncTask<String, String, Boolean> {
  ...
  protected Boolean doInBackground(String... arg0) {
    translatedText = Translator.translate(activity, sourceLanguageCode, targetLanguageCode, sourceText, activity.dataOffline);
