package quanlyduan_group7.snaptrans;
...
import quanlyduan_group7.snaptrans.camera.CameraManager;
import quanlyduan_group7.snaptrans.camera.ShutterButton;
import quanlyduan_group7.snaptrans.language.LanguageCodeHelper;
import quanlyduan_group7.snaptrans.language.TranslateAsyncTask;
...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback, 
  ...
  public void onCreate(Bundle icicle) {
    ...
    //Add new
    dataOffline = new Database(this);
    aboutButton = (Button) findViewById(R.id.about_button);
    aboutButton.setOnClickListener(new ButtonClickHandler());

    settingButton = (Button) findViewById(R.id.setting_button);
    settingButton.setOnClickListener(new ButtonClickHandler());
  ...
  public boolean onCreateOptionsMenu(Menu menu) {
    ...
    menu.add(0, ABOUT_ID, 1, "About").setIcon(android.R.drawable.ic_menu_info_details);
    return true;
  }
  /////////////
  public class ButtonClickHandler implements View.OnClickListener {
    public void onClick(View view) {
      Log.v(TAG, "Starting listen buttons");
      int id = view.getId();
      myIntents(id);
    }
  }
  public  boolean myIntents(int id)
  {
    Intent intent;
    switch (id) {
